...
data_dir=${1:-data}
mkdir -p "${data_dir}"
train_data_file=$data_dir/python_preprocessed_train.txt
valid_data_file=$data_dir/python_preprocessed_valid.txt
test_data_file=$data_dir/python_preprocessed_test.txt
